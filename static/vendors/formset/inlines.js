...
'use strict';
{
    ...
    $.fn.formset = function(opts) {
        ...
        const addInlineAddButton = function() {
            if (addButton === null) {
                if ($this.prop("tagName") === "TR") {
                    ...
                    $parent.append('<tr><td colspan="' + numCols + '"><a class="' + options.addCssClass + '" href="#">' + options.addText + "</a></tr>");
        ...
        const addInlineDeleteButton = function(row) {
            ...
            const deleteSelector = $.trim(options.deleteCssClass).replace(/\s+/g, '.')
            row.find("a." + deleteSelector).on('click', inlineDeleteHandler);
        };
    ...
    // Tabular inlines ---------------------------------------------------------
    $.fn.initFormset = function(selector, options) {
        const $rows = $(this);
    ...
    document.addEventListener("DOMContentLoaded", function () {
        $(".js-inline-formset").each(function() {
            const prefix = this.dataset.formset-prefix;
            const addText = this.dataset.formset-addtext;
            const deleteText = this.dataset.formset-deletetext;
            
            const selector = ".inline." + prefix;
